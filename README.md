...
スマホ幅とタブレット幅で使える、オフライン日本語入力対応の Android IME です。Foldでは閉じたスマホ幅と開いたタブレット幅の両方へ同じ操作体系で対応します。5つのレイヤー（かな、テンキー、カーソル、QWERTY、記号）を Custom View で描画し、同梱した Mozc 辞書でかな漢字変換と確定後の次単語予測を行います。入力文字をログや端末外へ送信しません。

...
The derived data remains available under Creative Commons Attribution-ShareAlike 4.0; the full terms are in `CC-BY-SA-4.0.txt`. The generator is project source code; wordfreq code is separately Apache-2.0 licensed in `WORDFREQ-CODE-LICENSE.txt`.



The following attribution notice is reproduced from wordfreq:

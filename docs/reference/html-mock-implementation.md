...
開始点から高い8/標準12/低い16pxで軸を固定し、高い12/標準18/低い26pxで選択を開始します。選択後は高い7/標準10/低い14pxのヒステリシスで中心復帰を判定します。かな・テンキーとQWERTY・記号の感度は独立し、日本語は設定した選択距離以上で、横優勢なら左・右、縦優勢なら上・下を選びます。

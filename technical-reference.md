...
16. QWERTY、記号、日本語、テンキー、カーソル、VOICEの全4行layoutは縦gap 10dpを共有する。高さは保存済み`KeyboardHeightPreset`だけで決め、小/標準/大はrow pitch 50/55/60dp、face 40/45/50dp、キー領域208/228/248dpとする。標準は旧スマホ幅の55dp値であり、画面幅とDual Flickは列数だけを変える。単一/二組の日本語配列と縦長Enterにも同じ縦geometryを適用し、横gap 6dpを維持する。（2026-09-11 / 260911-063048-unify-four-row-keyboard-heights, 260911-072658-unify-all-four-row-layout-heights; 2026-09-12 / 260912-014943-fixed-keyboard-height）

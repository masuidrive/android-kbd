...
- [ ] Fold7展開内画面の実利用可能幅と、左右2セットで各キーを押しやすい幅を測り、単一/dualのthreshold候補を記録する。
- [ ] 左右の12キーを交互入力・同時touchし、入力順、欠落、pointer/gesture競合、composition保持を観察する手順を定める。
...
- 後日まとめて作業する追加指示として起票のみ実施。`./ticket.sh start`、実装、probeは未実行。

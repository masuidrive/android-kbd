...
started_at: 2026-09-11T06:18:37Z # Do not modify manually
...
- [x] AC 1: QWERTY英字キーを下へスワイプすると、上部の補助ラベルがアニメーションしながらキーの縦中央まで移動する。
- [x] AC 2: 指を離すかキャンセルすると、補助ラベルは元の上部位置へ戻る。
- [x] AC 3: 上スワイプの大文字表示、タップ入力、Enter→pasteなど他のラベルアニメーションは変わらない。

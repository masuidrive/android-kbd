...
- [ ] AC 2: URL、メール、Webメール、文字パスワード、可視パスワード、Webパスワード、ASCII強制の入力欄では、最初からQWERTYレイヤーが表示される。
...
- `EditorInfo.inputType` のclass/variationと `IME_FLAG_FORCE_ASCII` から、入力開始時の表示レイヤーだけを決める。

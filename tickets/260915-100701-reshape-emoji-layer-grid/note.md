...
- [ ] ユーザ依頼: 絵文字レイヤーからBackspaceを削除する
- [ ] ユーザ依頼: Backspace跡を含む最下段まで絵文字一覧を広げる
- [ ] ユーザ依頼: 絵文字レイヤーを開くたびRecentタブから始める
- [ ] ユーザ依頼: 左のレイヤー切替列をかなレイヤー左列と同じ幅にする
- [ ] ユーザ依頼: 左列最上段を絵文字から日本語レイヤー切替へ置き換える
- [ ] ユーザ依頼: nativeと操作mockを揃え、APKと製品ページを公開する

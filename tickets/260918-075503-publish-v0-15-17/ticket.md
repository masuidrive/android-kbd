...
- [ ] AC 1: GitHubのpublicな`masuidrive/android-kbd` mainにv0.15.17のソースと公開記録があり、Releaseには未圧縮APKが1個だけ添付される。
- [ ] AC 2: 公開APKがローカル最終成果物とbyte一致し、package、versionCode 33、versionName 0.15.17、ARM64 ABI、RECORD_AUDIOあり、INTERNETなしを確認できる。
- [ ] AC 3: 公開APKと操作モックで、QWERTY 2行目右端が0.5wの`.`／下フリック`?`、3行目右端が1w Backspace／下フリックEscとなり、未割当方向がno-opである。
- [ ] AC 4: `https://masuidrive.jp/products/md-kbd/`とマニュアルがv0.15.17のAPK直リンクと変更点を表示し、スマホ・wide幅で横overflowを起こさない。

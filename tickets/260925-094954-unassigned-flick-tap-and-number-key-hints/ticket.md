...
- かな・数字とQWERTY・記号の二組に、独立した「高い」「標準」「低い」の3段階設定を置く。標準は従来の選択開始18dp・中心復帰10dp・軸固定12dpを保つ。
- 高い/標準/低いの選択開始は12/18/26dp、中心復帰は7/10/14dp、縦方向専用キーの軸固定は8/12/16dpとする。Spaceのカーソル移動距離・長押し時間・tapの当たり判定は変えない。
